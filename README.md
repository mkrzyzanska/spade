...
It has been developed as part of the [**Quantifying Uncertainty in Expert Archaeological Evidence (QUEADE)**](https://sheffield.ac.uk/mps/research/maths/queade) project funded by the Leverhulme Trust (RPG-2023-323) and accompanies the publication:  
...
The elicitation methodology used in the software was originally implemented in the general-purpose [SHELF](https://github.com/OakleyJ/SHELF) package (recommended for applications that do not involve artefact dates). [SHELF](https://github.com/OakleyJ/SHELF) is accompanied by a range of general-purpose elicitation tutorials that provide a useful introduction to elicitation, which can be found [here](https://shelf.sites.sheffield.ac.uk/).

Beyond the app, SPADE provides a suite of functions that can be used to load elicited dates saved from the app into an R session and process them to reproduce plots generated by the app or perform further analysis. An example workflow can be found ['here'](https://github.com/mkrzyzanska/QUEADE/blob/main/queade.R) file.


## Running the App Online

The elicitation app and tutorial available in this package are hosted on [shinyapps.io](https://www.shinyapps.io/) and can be accessed with the following links:  

- **Main App:** [https://queade.shinyapps.io/spade/](https://queade.shinyapps.io/spade/)
- **Tutorial:** [https://queade.shinyapps.io/spade-tutorial-1/](https://queade.shinyapps.io/spade-tutorial-1/)
...
Running SPADE locally requires an R installation ([instructions here](https://www.r-project.org/)).
...
This repository contains modified code from the **SHELF** package [(Oakley, 2015)](https://doi.org/10.32614/CRAN.package.SHELF) under the GNU General Public License. It also repurposes a data class from the **rcarbon** package [(Bevan and Crema, 2017)](https://doi.org/10.32614/CRAN.package.rcarbon) with a view to developing interoperability between the two packages in the future.
